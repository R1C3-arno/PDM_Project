      ...
      <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
            ...
            <div>
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: premiumTheme.spacing.md }}>
                  {[
                    { label: 'View Offer', path: `/app/applications/${params.id}/offer`, available: true },
                    { label: 'Upload Documents', path: `/app/applications/${params.id}/documents`, available: true },
                    { label: 'View Contract', path: `/app/applications/${params.id}/contract`, available: false },
                    { label: 'Repayment Schedule', path: `/app/applications/${params.id}/repayment`, available: false },
                  ].map((action, idx) => (
                    <button
                      key={idx}
        ...
        {activeTab === 'documents' && (
          <div style={{
            ...
            <button
              onClick={() => router.push(`/app/applications/${params.id}/documents`)}
              style={{
                padding: '14px 28px',
