...
export default function ApplicationsListPage() {
  ...
  const fetchApplications = async () => {
    try {
      ...
      setApplications([
        { id: 1, amount: 5000, purpose: 'Home Improvement', status: 'UNDER_REVIEW', createdAt: '2025-01-15', requestedTerm: 12 },
        { id: 2, amount: 10000, purpose: 'Business Expansion', status: 'APPROVED', createdAt: '2025-01-10', requestedTerm: 24 },
        { id: 3, amount: 2500, purpose: 'Education', status: 'SUBMITTED', createdAt: '2025-01-08', requestedTerm: 6 },
      ]);
    } finally {
      setLoading(false);
    }
                  ...
                  {filteredApplications.map((app) => (
                    ...
                    >
                      ...
                      <td style={{ ...tableCellStyle, textAlign: 'center' }}>
                        {app.requestedTerm ? `${app.requestedTerm} mo` : '-'}
                      </td>
                      <td style={{ ...tableCellStyle, textAlign: 'center' }}>
