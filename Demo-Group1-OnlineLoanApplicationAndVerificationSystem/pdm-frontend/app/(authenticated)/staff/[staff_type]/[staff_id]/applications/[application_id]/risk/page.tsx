...
export default function RiskAssessmentPage() {
  ...
  const loadData = async () => {
    try {
      const appData = await apiClient.get(`/applications/${params.application_id}`) as any;
      setApplication(appData);

      try {
        const assessmentData = await apiClient.get(`/risk/application/${params.application_id}`) as any;
